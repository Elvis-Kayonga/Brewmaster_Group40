  ...
  Future<String?> createListing(CoffeeListing listing, List<File>? images) async {
    ...
    try {
      ...
      if (images != null && images.isNotEmpty) {
        ...
        await _listingService.updateListing(listingId, updatedListing);
      }
  ...
  Future<bool> updateListing(CoffeeListing listing, List<File>? newImages) async {
    ...
    try {
      if (newImages != null && newImages.isNotEmpty) {
        ...
        await _listingService.updateListing(listing.listingId, updatedListing);
      } else {
        await _listingService.updateListing(listing.listingId, listing);
      }

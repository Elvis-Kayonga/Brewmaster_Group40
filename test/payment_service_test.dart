...
void main() {
  group('PaymentService Property Tests', () {
    ...
    group('Transaction Creation', () {
      test(
        'Property: Every created transaction should have unique ID',
        () async {
          final ids = <String>{};
          ...
          expect(
            ids.length,
            10,
            reason: 'All transaction IDs should be unique',
          );
        },
      );
      ...
      test('Property: Transaction should initialize status history', () async {
        ...
        expect(
          transaction.statusHistory.isNotEmpty,
          true,
          reason: 'Status history should be initialized',
        );
        expect(
          transaction.statusHistory.containsKey('pending'),
          true,
    ...
    group('Fund Release Properties', () {
      ...
      test(
        'Property: Total amount should equal sum of completed transactions',
        () async {
